...
Now that you've seen how JS.SSG converts your Markdown into HTML, it's time to customise that HTML using one of JS.SSG's most powerful features: [Templates](/getting-started-templates)
