            ...
            <ul class="menu">
                ...
                <div class="menu__block">
                    <li class="menu-item cluster ${
                        page.title === "Search" ? `current-menu-item` : ""
                    }" >
                        <form action="/search" class="integrated-search__form js__integrated-search__form">
                            <button type="button" class="integrated-search__icon js__integrated-search__toggle">
                                <svg class="menu-item__icon" width="16px" height="16px" viewBox="0 0 178 178" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <div class="integrated-search__form-body js__integrated-search__form-body hidden">
                                <label class="hidden--visually" class="menu-item__text">Search</label>
                                <input name="q" class="js__integrated-search__input" type="text" id="header-search" placeholder="Search">
                            </div>
                        </form>
                    </li>
                    <li class="menu-item ${
                        page.title === "Home" ? `current-menu-item` : ``
                    }">
                        <a href="/">About</a>
                    </li>
                    <li class="menu-item ${
                        page.title === "Archive" ? `current-menu-item` : ``
                    }">
                        <a href="/archive">Archive</a>
                    </li>
                    <li class="menu-item menu-item--has-icon">
                        <a class="header__feed-link" title="RSS feed" href="/feed.xml">
                            <span class="menu-item__text">Feed</span>
                            <svg class="menu-item__icon" width="16px" height="16px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <circle cx="25" cy="175" r="25"></circle>
                            </svg>
                        </a>
                    </li>
                    <li class="menu-item menu-item--has-icon">
                        <button class="js__dark-mode-toggle dark-mode-toggle dark-mode-toggle--off" type="button">
